  ...
  overview: [
    {
      ...
      description: 'The Data Exploration Platform (DEP) is a secure, collaborative playground tailored for analysts and data scientists. Here you can discover enterprise datasets, request granular access, write Python or SQL in sandbox Jupyter notebooks, and query governed AI assistants with live charting. Let\'s get you familiarized with the core systems.',
      actionHint: 'Click "Start Guide" to begin.',
    },
    {
      targetId: 'tour-sidebar-dashboard',
      title: '1. Platform Dashboard',
      description: 'Your home base. Analysts can monitor their active workspaces, permitted catalogs, pending access requests, and quick action cards to launch notebooks or request datasets immediately.',
      actionHint: 'Click "Next" to continue.',
    },
    {
      targetId: 'tour-sidebar-tutorials',
      title: '2. Interactive Tutorials Hub',
      description: 'Access templates, copy-pasteable SDK examples, and policy guides. Test out SDK functions like dep.whoami() directly inside the integrated dry-run CLI terminal.',
      actionHint: 'Click "Next" to explore the catalog.',
    },
    {
      targetId: 'tour-sidebar-explorer',
      title: '3. Catalog Explorer',
      description: 'Browse all registered datasets across the enterprise. Inspect column names, data types, and request column-level or row-filtered data permissions with a single click.',
      actionHint: 'Click "Next" to check your permissions.',
    },
    {
      targetId: 'tour-sidebar-access',
      title: '4. My Data Access',
      description: 'View your active dataset permissions, see exact column-level masking rules and row-level filters applied to your account, and track your pending/approved requests.',
      actionHint: 'Click "Next" to check workspaces.',
    },
    {
      targetId: 'tour-sidebar-workspaces',
      title: '5. Isolated Jupyter Workspaces',
      description: 'Create and launch isolated JupyterLite sandbox workspaces. Run live Python/pandas scripts and explore datasets dynamically with automated security policies applied.',
      actionHint: 'Click "Next" to check saved artifacts.',
    },
    {
      targetId: 'tour-sidebar-artifacts',
      title: '6. Saved Artifacts Catalog',
      description: 'All your generated tables, models, and charts saved via the SDK are stored here. View, share, or download them at any time.',
      actionHint: 'Click "Next" to meet the AI Client.',
    },
    {
      targetId: 'tour-sidebar-ai-client',
      title: '7. Governed AI Assistant',
      description: 'Ask questions, write queries, or analyze your permitted datasets using our integrated LLM client. Renders inline interactive charts (recharts/mermaid) and handles full thought-signature tracking.',
      actionHint: 'Click "Next" to check governance.',
    },
    {
      targetId: 'tour-sidebar-acl',
      title: '8. Governance & ACL Policies',
